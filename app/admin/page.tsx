                    ...
                    <div className="grid grid-cols-2 gap-6">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-4 py-3 border-2 border-slate-200 rounded-xl focus:ring-4 focus:ring-rose-500/20 focus:border-rose-500 outline-none font-medium"
                          placeholder="z.B. Regulatorisches Risiko"
                        />
                      </div>
                    </div>
                  </Card>
